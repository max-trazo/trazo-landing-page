...
export function DemoBookButton() {
    return (
        <button onClick={() => window.open('https://app.apollo.io/#/meet/9mr-p7h-my3/45-min', '_blank')} className="bg-white relative rounded-[8px] shrink-0 border border-[#d5d7da] shadow-sm">
